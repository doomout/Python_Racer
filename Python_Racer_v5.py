...
def main(): 
    ...
    while True:
        ...
        draw_text(screen, "lap {}/{}".format(laps, LAPS), 100, 30, WHITE, fnt_m) #주행 횟수
        draw_text(screen, "time " + time_str(rec), 100, 80, GREEN, fnt_s) #시간표시
        for i in range(LAPS):
        ...
        if idx == 4: #차종 선택
            move_car(0)
            draw_text(screen, "Selet your car", 400, 160, WHITE, fnt_m)
            for i in range(3):
                x = 160 + 240 * i
                y = 300
                col = BLACK
